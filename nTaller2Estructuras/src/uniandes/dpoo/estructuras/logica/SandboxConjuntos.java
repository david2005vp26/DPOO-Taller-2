...
public class SandboxConjuntos
{
    ...
    public String getPrimera( )
    {
         ...
         return Collections.min(arbolCadenas);
    }
    ...
    public String getUltima( )
    {
         ...
         return Collections.max(arbolCadenas);
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
	    ...
	    for (String palabra : arbolCadenas) {
	        if (palabra.toLowerCase().equals(cadenaEnMinusculas)) {
    ...
    {
    	NavigableSet<String> conjuntoMayusculas = new TreeSet<>();

        for (String palabra : arbolCadenas) {
            conjuntoMayusculas.add(palabra.toUpperCase());
        }

        arbolCadenas = conjuntoMayusculas;
    }
