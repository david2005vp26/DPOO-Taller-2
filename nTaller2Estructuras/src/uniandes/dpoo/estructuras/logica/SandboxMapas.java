...
public class SandboxMapas
{
    ...
    {
    	List<String> referenciaLlaves = new ArrayList<>();

        for (Map.Entry<String, String> entrada : mapaCadenas.entrySet()) {
            if (entrada.getValue().equals(valor)) {
            	referenciaLlaves.add(entrada.getKey());
            }
        }

        for (String llave : referenciaLlaves) {
            mapaCadenas.remove(llave);
        }
    }
    ...
    public void reiniciarMapaCadenas( List<Object> objetos )
    {
        ...
        for (Object objeto : objetos) {
            ...
            mapaCadenas.put(objetoString, objetoString);
        }
    }
